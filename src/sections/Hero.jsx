...
import HerotExperience from "../components/HerotExperience"

const Hero = () => {
    return (
        <section id="hero" className="h-dvh relative text-white-50 px-5 md:p-0">
            ...
            <div className="w-full h-full flex-center">
                <div className="container relative w-full h-full">
                    <div className="md:mt-40 mt-20">
                        ...
                        <h1 className="font-bold md:text-9xl text-5xl">SUN QUAN</h1>
                        <h1 className="font-bold md:text-9xl text-5xl">CREATVE</h1>
                    </div>
